# Support for Output Descriptors in Bitcoinwallet Core

Since Bitcoinwallet Core v0.17, there is support for Output Descriptors in the
...
on Bitcoinwallet's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bitcoinwallet Core wallets, a convenience function `combo` is
