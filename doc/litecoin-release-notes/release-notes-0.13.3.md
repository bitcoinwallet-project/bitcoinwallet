Bitcoinwallet Core version 0.13.3 is now available from:

  <https://download.bitcoinwallet.org/bitcoinwallet-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/bitcoinwallet-project/bitcoinwallet/blob/0.13/src/chainparams.cpp#L214).
