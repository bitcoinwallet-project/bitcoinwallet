...
"""Verify that starting bitcoinwallet with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinwallet with -h for help text")
        ...
        self.log.info("Start bitcoinwallet with -version for version information")
        ...
        self.log.info("Start bitcoinwalletd with -fakearg to make sure it does not start")
