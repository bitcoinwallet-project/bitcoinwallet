...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinwallet-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinwallet-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinwallet transaction\n" +
            "or:     bitcoinwallet-tx [options] -create [commands]   Create hex-encoded bitcoinwallet transaction\n" +
            "\n";
