...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = " 22/Apr/2020 Covid-19 causes sudden strokes in young adults, doctors say";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1587583928, 2084704757, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        //assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
        assert(consensus.hashGenesisBlock == uint256S("0x53d32320d8323fd6683f70c73a12db0da035657facfd538a4d8e245e97442068"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
       ...
       // vSeeds.emplace_back("seed-a.bitcoinwallet.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.bitcoinwallettools.com");
        //vSeeds.emplace_back("dnsseed.bitcoinwalletpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xff, 0x8c, 0xB6, 0x1d};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x82, 0xAB, 0xE9};
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1587583928, 293345, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x53d32320d8323fd6683f70c73a12db0da035657facfd538a4d8e245e97442068"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
        ...
        //vSeeds.emplace_back("testnet-seed.bitcoinwallettools.com");
        //vSeeds.emplace_back("seed-b.bitcoinwallet.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1587583928, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x53d32320d8323fd6683f70c73a12db0da035657facfd538a4d8e245e97442068"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
        ...
        chainTxData = ChainTxData{
            ...
            1587583928, // * UNIX timestamp of last known number of transactions
